...
const FilesModel = ({ file, setFile, setFile_name, file_name, openFileModel, setOpenFileModel, handleChange, addAssignments, current, setCurrent, removeAssignments }) => {
  return (
    <Modal
      title={current.name}
      centered
    ...
    >
      ...
      <List
        ...
        renderItem={(item) => (
          <List.Item actions={[<BiTrash role="button" onClick={() => removeAssignments(current._id, item._id)} />]}>
