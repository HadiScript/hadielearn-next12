    ...
    <>
      <section className="counter__area pt-140 pb-20">
        <div className="container">
          <div className="row">
            <SingleCount counter={1500} title="Live classes" color="primary" />
            <SingleCount counter={30000} title="Enrolled Students" color="secondary" />
            <SingleCount counter={3000} title="Students on waitlist" color="primary" />
            <SingleCount counter={50000} title="Queries answered" color="secondary" />
          </div>
        </div>
      </section>
    </>
