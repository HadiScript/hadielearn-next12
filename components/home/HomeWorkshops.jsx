            ...
            <div className="col-xl-5 offset-xl-7 col-lg-6 offset-lg-6 col-md-7 offset-md-5">
              <div className="faq__wrapper">
                ...
                <p style={{ fontSize: "18px" }}>
                  Join our free online workshops on a variety of topics to gain valuable insights and practical knowledge from the comfort of your own home. Our team of experts
                  will guide you through interactive sessions, ensuring you leave with a deeper understanding of the subject matter. Register now to secure your spot!
                </p>
