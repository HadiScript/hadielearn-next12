      ...
      <div className="container pt-90">
        <div className="about__content">
          ...
          <p>
            ...
            use of <strong>Hadi E-learning</strong>, located at{" "}
          ...
          <p>
            ...
            conditions. Do not continue to use <strong>Hadi E-learning</strong>{" "}
          ...
          <p>
            ...
            <strong>Hadi E-learning</strong>, you agreed to use cookies in
            agreement with the{" "}
            <a href="https://hadielearning.com/privacy-and-policy">
              privacy policy{" "}
            </a>{" "}
            of <strong>Hadi E-learning.</strong>
          </p>
          <p>
          ...
          <h2>License</h2>
          <p>
            Unless otherwise stated, <strong>Hadi E-learning</strong> and/or its
            licensors own the intellectual property rights for all material on{" "}
            <strong>Hadi E-learning.</strong> All intellectual property rights
            are reserved. You may access this from{" "}
            <strong>Hadi E-learning</strong> for your own personal use subjected
          ...
          <p>
            ...
            <strong>Hadi E-learning</strong> does not filter, edit, publish or
            review Comments prior to their presence on the website. Comments do
            not reflect the views and opinions of{" "}
            <strong>Hadi E-learning</strong>, its agents and/or affiliates.
            ...
            <strong>Hadi E-learning</strong> shall not be liable for the
          ...
          <p>
            <strong>Hadi E-learning</strong> reserves the right to monitor all
          ...
          <p>
            You hereby grant <strong>Hadi E-learning</strong> a non-exclusive
          ...
          <p>
            ...
            <strong>Hadi E-learning</strong>; and (d) the link is in the context
          ...
          <p>
            ...
            sending an e-mail to <strong>Hadi E-learning.</strong> Please
          ...
          <p>
            No use of the logo of <strong>Hadi E-learning</strong> or other
          ...
          <p>
            ...
            and the use of this website. Nothing in this{" "}
            <a href="https://hadielearning.com/disclaimer">disclaimer</a> will:
          </p>
          <ul className="list-group list-group-flush">
            <li className="list-group-item">
