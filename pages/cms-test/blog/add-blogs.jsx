...
const NewBlogAdd = () => {
  ...
  const submitForm = async (e) => {
    ...
    _formData.append("image", image); // Assuming `image` is the File object from an input type="file"
    ...
    try {
      setLoading(true);
      const { data } = await axios.post(`${API}/create-blog`, _formData, {
        headers: {
    ...
    <>
      <CMSLayout>
        <Card>
          ...
          <div className="form-group py-2">
            {/* <h5 for="exampleFormControlInput1">Content Image</h5>
